                ...
                <div className="space-y-3">
                    ...
                    {result.detection_reason && (
                        <div className="flex justify-between items-start gap-4">
                            ...
                            <span
                                className="text-violet-400 text-right text-sm max-w-sm">{result.detection_reason}</span>
                        </div>
                    )}
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <span
                            className="text-secondary-foreground font-mono text-sm">{result.filename || "Unknown"}</span>
                    </div>
                </div>
            </CardContent>
        </Card>
                ...
                <div className="bg-mini-card/50 rounded-lg p-4 mt-2">
                    <div className="flex justify-between items-center mb-2">
                        ...
                        <Badge className={`${malwareColor}`}>
                            {malwareClassification.includes("null") || malwareClassification.includes("Failed") ? 'Unable to classify' : malwareClassification}
                        </Badge>
                    </div>
                </div>
            </CardContent>
            ...
            <CardContent className="p-6">
                ...
                Found {suspicions.length} suspicious actions
                    ...
                    <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4 text-center">
                        ...
                        <p className="text-green-400 font-medium">Nothing suspicious found</p>
                        <p className="text-muted-foreground text-sm">Celestial could not find anything suspicious</p>
                    </div>
                )}
            </CardContent>
        </Card>
        ...
        <div className="bg-background text-foreground">
            <div className="container mx-auto mt-10 sm:px-6 px-4 py-8">
                {loading && (
                    ...
                    >
                        ...
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-sm text-muted-foreground/70">Please wait while we complete the
                                analysis...</p>
                        </div>
                    </motion.div>
                )}
                ...
                {!loading && !hasStartedScan && (
                    ...
                    >
                        <Card border={false}
                              className="mb-8 bg-transparent flex flex-col items-center justify-center h-[80vh] space-y-6">
                            <CardContent className="p-8">
                                <div className="text-center">
                                    <div className="p-4 bg-secondary/20 rounded-full w-fit mx-auto mb-4">
                                        <Upload className="w-12 h-12 text-foreground"/>
                                    </div>
                                    <h2 className="text-xl font-semibold text-foreground mb-2">Upload File for
                                        Scanning</h2>
                                    <p className="text-muted-foreground mb-6">Select a file to analyze for potential
                                        threats,
                                        max 500mb</p>
